...
// console.log(arr.pop()); ------> Removes the value present in the Last Index permanently
// console.log(arr.reverse()); ------> Reverses the elements present in the array
// console.log(arr.push([12,13])); -----> Add the Element to the last index of the array Permanently
...
// console.log(arr.shift()); ----> Removes the vale present in the 0th Index Permanently
